...
public class PacketOpcodes {
    ...
    // Opcodes
    public static final int AADPKGHELAD = 8605;
    ...
    public static final int ACBKFHEFAGO = 8336;
    public static final int AcceptCityReputationRequestReq = 2835;
    public static final int AcceptCityReputationRequestRsp = 2849;
    public static final int ACGNCGKKOFF_Rsp = 4270;
    public static final int ACHELBEEBIP = 21518;
    ...
    public static final int ADPGNMPMGGA = 8595;
    public static final int AEGLIPEBIBI_Rsp = 6246;
    public static final int AEGNGOHKDCD = 8082;
    public static final int AFENLDPNNJE_Notify = 4829;
    public static final int AFENNHDAHMJ = 8616;
    public static final int AGFKLBOPBLF_Req = 6241;
    public static final int AHNDINCCBFI = 8028;
    public static final int AIAMBDCLAKM = 8296;
    public static final int AINEKFCFFOH_Req = 4039;
    public static final int AIPCOCEFFEJ = 8464;
    ...
    public static final int AMBEOGIDODB = 8835;
    public static final int AMDACODCFCH = 8125;
    public static final int AMEOJHNDAEJ = 8884;
    public static final int AMHHEDJMLII = 8952;
    public static final int AMMEFIENNFK = 8414;
    ...
    public static final int ANGBHKDBBOE = 8961;
    public static final int ANGFAFEJBAE = 836;
    public static final int AnimatorForceSetAirMoveNotify = 346;
    public static final int ANOBFOHNNLK = 8843;
    public static final int ANPHKDKMNPF = 8500;
    public static final int AntiAddictNotify = 148;
    public static final int AOIMEPMMJGJ_Req = 4257;
    public static final int APDKLEGAGOM = 8225;
    ...
    public static final int BAFILMPIENK = 8636;
    public static final int BAHBJGJGFPH = 8681;
    ...
    public static final int BCJKHHMJAFL_Notify = 2186;
    public static final int BCLHBNFMNMJ = 8165;
    public static final int BDAPDLLEMFE = 8999;
    public static final int BDAPFODFMNE = 20110;
    public static final int BDKJALHJDGD_Req = 2184;
    public static final int BDLGHAGPJJO = 8348;
    public static final int BeginCameraSceneLookNotify = 203;
    public static final int BENMEIIOJLI = 8924;
    public static final int BFNBMENLNGD_Rsp = 6210;
    public static final int BHPIAPHIDJE_Notify = 6235;
    public static final int BigTalentPointConvertReq = 1032;
    public static final int BigTalentPointConvertRsp = 1017;
    public static final int BKIGMKBLIBM = 8685;
    ...
    public static final int BMABIMADOJO = 8905;
    public static final int BMCEOPOJGIN = 8513;
    public static final int BMIHFBJGBPD = 8122;
    public static final int BNDBIONBGMH = 8783;
    public static final int BOFEHJBJELJ = 8228;
    public static final int BOHPGDFPMFF = 8601;
    ...
    public static final int BPGONOAHMKD_Req = 6215;
    ...
    public static final int CAEDDHEEPLK_Notify = 157;
    ...
    public static final int CAOAFPNFOPD_Notify = 4694;
    public static final int CardProductRewardNotify = 4104;
    public static final int CBIAEJOIDEC = 8351;
    public static final int CDOOPCFHGEJ = 8733;
    public static final int CEPGJCNMBGN_Rsp = 151;
    public static final int CFAIHKMMEPJ = 8859;
    public static final int CFGBDDMDGNN = 8775;
    public static final int CGFDKEECDJH = 8429;
    ...
    public static final int CHEDEMEDPPM = 5538;
    ...
    public static final int CHIBAJHHFED = 8014;
    public static final int CHJPAJCCAPF_Notify = 4826;
    public static final int ChooseCurAvatarTeamReq = 1800;
    public static final int ChooseCurAvatarTeamRsp = 1673;
    public static final int CILHNABKHEM = 8848;
    public static final int CINFBFPKLEF_Rsp = 6216;
    public static final int CityReputationDataNotify = 2898;
    public static final int CityReputationLevelupNotify = 2832;
    public static final int CKBHLGGEHCI = 8248;
    ...
    public static final int CLKINFFENIH = 8980;
    public static final int CLOKMLJCFAM = 8083;
    public static final int CLOODLIEDNF_Rsp = 4666;
    public static final int CloseCommonTipsNotify = 3496;
    public static final int ClosedItemNotify = 674;
    public static final int CNKKOJFKCAK = 8712;
    public static final int COCHLKHLCPO = 20846;
    public static final int CodexDataFullNotify = 4201;
    public static final int CodexDataUpdateNotify = 4210;
    public static final int COEAIMBMFGH = 8019;
    public static final int COENFDFKLKC_Notify = 9009;
    ...
    public static final int CPGKELAEADA = 8319;
    ...
    public static final int DALHNPMOAFJ_Rsp = 6211;
    public static final int DataResVersionNotify = 125;
    public static final int DBPICOLMDGO = 8436;
    public static final int DDOILNFJLDL = 8837;
    ...
    public static final int DFMIBDHHPJI = 8908;
    public static final int DGCKEFONLDN_Rsp = 6304;
    public static final int DGMBCGNPLIH = 8611;
    public static final int DHOJKNGMGJN = 8242;
    ...
    public static final int DIJCBBFFFHF_Req = 310;
    public static final int DisableRoguelikeTrapNotify = 8250;
    public static final int DKDJCLLNGNL = 8782;
    public static final int DNKCFLKHKJG = 833;
    public static final int DNNNMHLMLNB = 8265;
    public static final int DoGachaReq = 1541;
    public static final int DoGachaRsp = 1537;
    public static final int DONPCFCHINC = 8995;
    ...
    public static final int DPINLADLBFA = 1909;
    public static final int DPJJAFAEILG_Req = 6343;
    ...
    public static final int EACOHAIOEBF = 8034;
    public static final int EAJLINIEPFH = 8404;
    public static final int ECCLDPCADCJ = 1907;
    ...
    public static final int EDDLEOCMBLI = 8476;
    public static final int EDJOFFLMPPO = 8251;
    public static final int EEDLBHIIENK = 8449;
    public static final int EffigyChallengeInfoNotify = 2153;
    public static final int EffigyChallengeResultNotify = 2064;
    public static final int EFGCLMDCLNM_Notify = 5563;
    public static final int EFGFLEODAKD = 8614;
    public static final int EFOPJKCJKFO_Rsp = 6202;
    public static final int EGMOBMEJJEC_Req = 179;
    public static final int EJKEANINHBN_Req = 6217;
    public static final int EKGCCBDIKFI = 24262;
    public static final int EKGFKHDDNJP_Rsp = 4778;
    public static final int EKMPEIELDBO = 8221;
    public static final int ELEAINOCFNF_Req = 6072;
    public static final int ELHBLOKCGCK_Req = 4857;
    public static final int EMELKMGFOHK = 8089;
    public static final int EMFCGFPGHNB = 8501;
    public static final int EMLJBALKOLC = 8485;
    public static final int EMNLDGDANPL = 8590;
    ...
    public static final int EPAELKHNJDK_Rsp = 434;
    ...
    public static final int FABNGPOHINC = 8376;
    public static final int FAKBPENCJDH = 8664;
    public static final int FBIHMKKINKC_Notify = 910;
    public static final int FCALHLNLJLP = 8171;
    public static final int FDFCKBNKEIM = 8537;
    public static final int FEAINDEDJGD = 8543;
    public static final int FEHDMHEJELO_Req = 6218;
    public static final int FGLPMBHGPDF = 8608;
    public static final int FHBDCOFPKLD = 8368;
    public static final int FHCJIICLONO = 23005;
    public static final int FIILLMAEAKF_Req = 6213;
    public static final int FINDCLFLAFI = 8192;
    ...
    public static final int FLGOFOHLFPG = 8993;
    ...
    public static final int FNOOIKODAMF = 8157;
    ...
    public static final int FPKBAFJCJLB = 8535;
    ...
    public static final int GAHOKACOOPK_Req = 6318;
    public static final int GAKIGEGEOOL = 8468;
    ...
    public static final int GAOKCMIPKCN_Req = 6219;
    public static final int GBHDEENJMLE = 8971;
    public static final int GBMEMLEEPLA = 8110;
    public static final int GDDLBKEENNA = 22353;
    public static final int GDJLLGBCGAB_Rsp = 6347;
    ...
    public static final int GHODOLPLDLB_Notify = 429;
    ...
    public static final int GJPLNCFKGAN = 8104;
    public static final int GKLODHELEDN = 8901;
    public static final int GLJDBHJMGEE_Req = 6068;
    public static final int GLKCNNGIDHJ_Rsp = 6209;
    ...
    public static final int GNHAMMOFDCC = 8728;
    public static final int GNOECJLEMEF = 8724;
    public static final int GOGOIHBHMLE = 8153;
    public static final int GOKGHHLBOEK_Notify = 5934;
    public static final int GPJHHAFPFMM = 8879;
    public static final int GPMFNMCGONA = 8701;
    ...
    public static final int HAPIDEBLFEK = 8286;
    public static final int HBBCHEPOCNN_Rsp = 6237;
    public static final int HBHPOFAMPHH = 8173;
    public static final int HCLKGHOLNHB = 8133;
    public static final int HDHPGDEPEOJ = 8814;
    public static final int HFBGAAGFING = 8341;
    public static final int HGDPJNHOKKJ = 8350;
    public static final int HHLJFNKKAEM = 8661;
    public static final int HHPCNJGKIPP = 20577;
    public static final int HIBFNEOODMP = 8169;
    ...
    public static final int HIHOKDLIOGF = 8258;
    public static final int HIKAIAALILG_Req = 6302;
    public static final int HitClientTrivialNotify = 218;
    public static final int HitTreeNotify = 3222;
    public static final int HKBAEOMCFOD = 162;
    public static final int HKCKDHNPOND_Rsp = 6208;
    public static final int HKMIOIEKNBB_Notify = 50;
    public static final int HLCLODNFJPB_Rsp = 4670;
    public static final int HLEPGFPPCKL = 8523;
    public static final int HMALECLKBLI = 8223;
    public static final int HMGDLPKNFHN_Rsp = 169;
    public static final int HMPMBGGFLFP = 8445;
    public static final int HOJNBEEHBLK_Req = 6316;
    ...
    public static final int HONABEOFCIM = 8604;
    ...
    public static final int IAPHBOCMOFK_Notify = 3238;
    public static final int IBDOMAIDPGK = 5558;
    public static final int IBOAEFDMIEM_Notify = 6223;
    public static final int ICGHGPEONPH_Rsp = 6059;
    public static final int ICKAHCGNGII = 8326;
    public static final int IDDCFKICGBJ = 8808;
    public static final int IECLGDFOMFJ = 8191;
    public static final int IFPPKMHELIF = 8466;
    public static final int IGIJGKOJKOJ = 8592;
    public static final int IGKGDAGGCEC = 1611;
    public static final int IHCHFDMLIDE = 8454;
    public static final int IHCIJACAKOM = 8108;
    public static final int IIFFMFFJEDP = 5754;
    public static final int IILBEPIEBJO = 8262;
    public static final int IJJADMNPCLJ_Notify = 1958;
    public static final int IKEABDBEHFE_Req = 6247;
    public static final int ILKIAECAAKG = 3041;
    ...
    public static final int INLPFCEHMEM = 8494;
    ...
    public static final int IPKKFNMFJAL = 8776;
    ...
    public static final int JAECFJMJINE = 8209;
    public static final int JBBPNNCMGNN = 8818;
    public static final int JBHIKOECHMN_Rsp = 6214;
    public static final int JCLCGCLLIFP_Req = 6222;
    public static final int JCPNICABMAF = 5506;
    public static final int JEJLENMAPDL = 8488;
    public static final int JEOPOIEJPFG_Rsp = 4662;
    public static final int JFKPHDADHOD = 8114;
    public static final int JGJLAAHEADE = 8343;
    public static final int JHKAFPJFBPE = 8524;
    public static final int JIGMFCMPIIE = 8220;
    public static final int JJNGBDCFEOL = 8892;
    public static final int JLKGDNCNKGH = 8809;
    public static final int JMJBMMGCBFB = 8586;
    public static final int JMMFPEIKONF = 8922;
    public static final int JMNBINMGNGF = 8018;
    ...
    public static final int KAKCAFAPJDH = 8241;
    public static final int KBEBKLNKALE = 8237;
    public static final int KBJFNAIFHGD_Req = 6239;
    public static final int KCGOCMNBKII_Notify = 4053;
    public static final int KCHGEIEHAJP_Notify = 4074;
    public static final int KDDALBIKBLA_Notify = 4540;
    public static final int KDOLNIKFBOE_Notify = 6229;
    public static final int KEDKIGNGFDO = 8635;
    public static final int KeepAliveNotify = 9;
    public static final int KEPJGFNGPAN_Rsp = 6301;
    public static final int KFINGPKIBHF = 8620;
    public static final int KFNCDHFHJPD = 8797;
    public static final int KGKIADOIJJH_Req = 6212;
    public static final int KGMILKFKIKB_Notify = 144;
    public static final int KHIFHGEKPFG_Req = 6243;
    public static final int KHLHFFHGEHA = 20987;
    public static final int KILFIICJLEE = 5519;
    public static final int KILOGAAJMAP = 8483;
    public static final int KJEOLFNEOPF = 1614;
    public static final int KKBAPOEKHIJ_Notify = 6233;
    public static final int KKGJGHBNGOP = 8845;
    public static final int KLOHHCEMLBN = 8233;
    public static final int KMCDDNAPMKB_Notify = 5395;
    public static final int KMDDGFKAFPL_Rsp = 6250;
    public static final int KMFEGKDKBHK = 6332;
    public static final int KMHHECEJLPJ = 8263;
    public static final int KMNJJIOEHPE_Rsp = 5918;
    public static final int KNNFEADCCIE = 8413;
    public static final int KOMBBIEEGCP = 5524;
    public static final int KPENOPPHGKC_Notify = 4656;
    public static final int KPJKAJLNAED = 846;
    public static final int LAEEHPFIHMG = 8672;
    public static final int LAGNBCLNJKO = 8670;
    public static final int LAOGLKOEIMI = 8245;
    public static final int LBNNIDBBCOB = 8276;
    public static final int LBNOHPAJICG_Rsp = 6309;
    public static final int LBOJGKOMLOM = 8902;
    ...
    public static final int LEJKLPAECKC_Notify = 5339;
    public static final int LEKMHMJEGAG = 8434;
    public static final int LevelupCityReq = 287;
    public static final int LevelupCityRsp = 289;
    public static final int LGIKLPBOJOI = 8867;
    public static final int LIAHLEDFPFH = 8617;
    public static final int LIBCDGDJMDF = 5512;
    public static final int LifeStateChangeNotify = 1231;
    public static final int LIGFPJJOOBJ_Req = 6201;
    public static final int LIOFFHFLCHA_Notify = 4091;
    public static final int LiveEndNotify = 801;
    public static final int LiveStartNotify = 820;
    public static final int LKJAMELJDLF_Notify = 6268;
    public static final int LMGHNOPGPBK_Req = 425;
    public static final int LMJBPNLNKMP = 8366;
    public static final int LNDGCBMPEEO_Rsp = 366;
    ...
    public static final int MABFECLBGCG = 6314;
    public static final int MAHCJAEAKPE_Req = 403;
    public static final int MailChangeNotify = 1431;
    public static final int MainCoopUpdateNotify = 1959;
    public static final int MAKMILOAFNP_Rsp = 6204;
    ...
    public static final int MEEKBNDLPFM_Rsp = 1145;
    ...
    public static final int MGKBKAPNAED_Rsp = 5969;
    public static final int MGMBPEBEJPG = 8217;
    public static final int MHBPBNOHGLM = 8210;
    public static final int MHKAIPCABOL = 8086;
    public static final int MHKEIAJMEBP = 8240;
    public static final int MIJMLONPIKC_Req = 4545;
    ...
    public static final int MJGKOFBMJJH = 8224;
    public static final int MKIAFJKCMGB = 8546;
    public static final int MLGMJGFGIGJ_Rsp = 6244;
    public static final int MNBDNGKGDGF = 8293;
    public static final int MODCBJPBKFJ = 8572;
    ...
    public static final int MPMKKFPLJNO = 8713;
    public static final int MPOPBPLLCLE = 8795;
    public static final int MPOPNHNGDEP = 8693;
    ...
    public static final int NAKJLFKAIDN = 8177;
    public static final int NALFINJPKEC_Req = 6099;
    public static final int NavMeshStatsNotify = 2387;
    public static final int NBICPBPDGPK = 8882;
    public static final int NBJNPPEKGCF_Req = 4507;
    public static final int NBODFMNNKEL = 8095;
    public static final int NBOEHJKDJAM = 8754;
    public static final int NCPOFPFGMON = 8472;
    public static final int NEILMMCCJIL_Req = 6232;
    public static final int NFCBEHAHDEB_Notify = 5315;
    public static final int NFGPBBIDECF = 8957;
    public static final int NFPBBJDHHAG = 8113;
    public static final int NHDEPGCGABN_Rsp = 4475;
    public static final int NHEOHBNFHJD = 8283;
    public static final int NHHBCKBFPGH = 8811;
    public static final int NHLOIJJIMKH_Rsp = 4208;
    public static final int NIFCNKIFELG_Req = 6248;
    public static final int NIOCODJJAAG = 8397;
    public static final int NJEEGBNBPHO_Notify = 5586;
    public static final int NJFKEDEHFMI_Notify = 6240;
    public static final int NJMHCJKHOOJ = 8717;
    public static final int NJPDGJOIELH = 8437;
    public static final int NKKJHDJPLFA = 8894;
    public static final int NLANFNKHEAF = 8812;
    public static final int NLNGOBFLGLF_Notify = 6227;
    public static final int NMDLEKANPIC = 8297;
    public static final int NMFHPCGFILI_Req = 4664;
    public static final int NNCAEEPKEDO = 8480;
    public static final int NNEEDANHBGI_Req = 6326;
    public static final int NOGGJBMFLAB_Notify = 4528;
    public static final int NormalUidOpNotify = 5718;
    public static final int NPCEOIBBOAG_Req = 4755;
    public static final int NpcTalkReq = 509;
    public static final int NpcTalkRsp = 531;
    public static final int NPKFEMNDODK_Rsp = 4095;
    public static final int OAEONFPCBLA = 8299;
    public static final int OBDHHECCCEJ_Rsp = 2183;
    public static final int OBGAGDNALCG = 8344;
    public static final int ObstacleModifyNotify = 2341;
    public static final int OCDPHEENCMI_Notify = 4820;
    public static final int OCNHEKGDNND_Rsp = 6206;
    public static final int OCPFFDGHHFL = 8375;
    public static final int ODBJLDHFFGA_Req = 1198;
    public static final int ODLLIOFDJOG = 8708;
    public static final int OfferingInteractReq = 2908;
    public static final int OfferingInteractRsp = 2923;
    public static final int OFIHDGFMDGB = 126;
    public static final int OGBLINBAHEF = 8683;
    public static final int OGNJGAIDAFA = 8085;
    public static final int OHBAOBGCDKC_Notify = 6079;
    public static final int OHFMDOKJMII_Notify = 4663;
    public static final int OHLIEJAJLAP = 8847;
    public static final int OIDABHCHOHK_Notify = 5590;
    public static final int OILCHMMFCAF = 8059;
    public static final int OJEFMJOLHGL_Req = 164;
    public static final int OKGOFKCJJKO_Notify = 6224;
    public static final int OLDHIPAALKH_Notify = 6221;
    public static final int OLMDNNNFFOC = 8863;
    public static final int OLPACCEMCNB_Notify = 152;
    public static final int OMGNOBICOCD = 854;
    public static final int OMNCIFPILAL_Rsp = 483;
    public static final int ONBEJNEOIME = 8458;
    public static final int OneoffGatherPointDetectorDataNotify = 4262;
    public static final int ONIKKLHOECP = 8889;
    public static final int ONOMKMIELJH = 8361;
    public static final int ONPPDGICGAA = 8384;
    public static final int OOKIPFHPJMG = 22709;
    ...
    public static final int OPCJCIELOMK = 8053;
    ...
    public static final int PBFKIECIFOK_Notify = 4196;
    public static final int PBPMDOAJAEF = 4296;
    ...
    public static final int PFGIOIFMGGB_Notify = 4881;
    public static final int PGIJJGJOJFN = 8290;
    public static final int PIGGLKLDMON = 8625;
    public static final int PingReq = 32;
    public static final int PingRsp = 17;
    public static final int PKFOEADIKLN = 8801;
    public static final int PKIGCMIGINH = 8729;
    ...
    public static final int POJBBPACLHA_Rsp = 6313;
    public static final int POJHANANPLH = 6337;
    public static final int PostEnterSceneReq = 3097;
    public static final int PostEnterSceneRsp = 3344;
    public static final int PPHOPAIKBPL = 8491;
    public static final int PPOHFHCEKDP_Req = 4204;
    ...
    public static final HashSet<Integer> BANNED_PACKETS = new HashSet<Integer>() {{
        ...
        // Sry, but we need to send this packet to the client to patch
